 ...
 * @author Keyur
 */
@WebServlet(name = "BookStoreServlet", urlPatterns = {"/book-servlet/store"})
public class StoreServlet extends HttpServlet {
    ...
    private void store(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
        ...
        Book book = new Book(title, description, price, author_id);
        bookDAO.store(book);
        Message msg = new Message("New Book created succefully.", "success", "alert-success");
