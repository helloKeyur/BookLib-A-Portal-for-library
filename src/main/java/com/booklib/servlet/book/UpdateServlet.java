 ...
 * @author Keyur
 */
@WebServlet(name = "BookServlet", urlPatterns = {"/book-servlet/update"})
public class UpdateServlet extends HttpServlet {
    ...
    private void update(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
        ...
        Book book = new Book(id, title, description, price, author_id);
        
        bookDAO.update(book);
        Message msg = new Message("Book details Updated...", "success", "alert-success");
